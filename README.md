...
You need to create database with name "pretest" before you import the queries. Or if you want to create database with another name, please sync it to the source, you can open \src\main\resources\application.properties on "spring.datasource.url" line and change it to the same name with your own database.
